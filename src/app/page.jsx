...
export default function Blog() {
    ...
    return (
        <div className="w-full !max-w-full md:px-20 px-5  flex flex-col overflow-x-hidden w-full min-h-[100dvh]  flex flex-col justify-center items-center scroll-smooth">
